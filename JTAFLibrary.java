...
//        libraryPane.set
    ...
    public GridPane createCommandGridPane(Command command) {
        ...
        if (command.hasRequiredParameters()) {
            ...
            requiredParamPane.setBackground(new Background(new BackgroundFill(LIBRARY_ATTRIBUTE_COLOR, CornerRadii.EMPTY, Insets.EMPTY)));
            ...
            for(int i = 0; i < command.getRequiredParameters().size() * 3; i++) {
                ...
                requiredParamChildPane.setBackground(new Background(new BackgroundFill(LIBRARY_ATTRIBUTE_CHILD_COLOR, CornerRadii.EMPTY, Insets.EMPTY)));
        ...
        if (command.hasOptionalParameters()) {
            ...
            optionalParamPane.setBackground(new Background(new BackgroundFill(LIBRARY_ATTRIBUTE_COLOR, CornerRadii.EMPTY, Insets.EMPTY)));
            ...
            for(int i = 0; i < command.getOptionalParameters().size() * 3; i++) {
                ...
                optionalParamChildPane.setBackground(new Background(new BackgroundFill(LIBRARY_ATTRIBUTE_CHILD_COLOR, CornerRadii.EMPTY, Insets.EMPTY)));
        ...
        if (command.hasCommandResults()) {
            ...
            resultsPane.setBackground(new Background(new BackgroundFill(LIBRARY_ATTRIBUTE_COLOR, CornerRadii.EMPTY, Insets.EMPTY)));
            ...
            for(int i = 0; i < command.getCommandResults().size() * 3; i++) {
                ...
                resultsChildPane.setBackground(new Background(new BackgroundFill(LIBRARY_ATTRIBUTE_CHILD_COLOR, CornerRadii.EMPTY, Insets.EMPTY)));
